...
- Extract key revelations and insights
- Get actionable takeaways
- Export to Obsidian, Logseq, or Markdown
- Choose your AI provider (Claude, GPT-4, or Gemini)
- Beautiful, newspaper-inspired UI
...
- Issues: [GitHub Issues](https://github.com/ndimoro/tldw-youtube-summarizer/issues)
